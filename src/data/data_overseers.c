...
const Overseer OVERSEERS[] = {
    {
        ...
        .effects[0]  = {.trigger = TRIGGER_BATTLE_START,
                        EFF(OVERSEER_IRON_STRATEGIST,
    ...
    },
    {
        ...
        .effects[0]  = {.trigger = TRIGGER_PIECE_FLIPPED,
                        EFF(OVERSEER_ETERNAL_RECURSION,
    ...
    },
    {
        ...
        .effects[0]  = {.trigger = TRIGGER_TURN_END,
                        EFF(OVERSEER_CARAVAN_OF_CONQUEST,
